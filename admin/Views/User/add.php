                                ...
                                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">                                         
                                            <div class="row">
                                                <div id="preview">
                                                    <img class="rounded mb-3" id="image_preview" src="../Public/uploads/users/default.png" onclick="clickUpload();" style="width: 300px; height: 300px;" alt="default picture">
                                                </div>                                                
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 offset-md-1">                                
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="password" id="" class="form-control" placeholder="" aria-describedby="helpId" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repassword" id="" class="form-control" placeholder="" aria-describedby="helpId" required>
                                            </div>
                                        </div>
                                    </div>          
                                    <div class="row">
                                    ...
                                    <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                <button type="submit" name="addUser" class="btn btn-primary">Add new</button>
